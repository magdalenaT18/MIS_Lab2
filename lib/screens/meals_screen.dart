...
class _MealsScreenState extends State<MealsScreen> {
  ...
  void filterMeals(String query) async {
    if (query.isEmpty) {
      ...
      // Filter searchedMeals by category because search.php is global
      searchedMeals = searchedMeals.where((m) => m.idMeal != null && m.idMeal.isNotEmpty).toList();
      setState(() {
            ...
            child: GridView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return GestureDetector(
                  onTap: () async {
                    final detail = await apiService.getMealDetails(meal.idMeal);
                    Navigator.push(
                      context,
